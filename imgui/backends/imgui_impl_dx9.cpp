...
//  2024-02-12: DirectX9: Using RGBA format when supported by the driver to
//  avoid CPU side conversion. (#6575) 2022-10-11: Using 'nullptr' instead of
//  'NULL' as per our switch to C++11. 2021-06-29: Reorganized backend to pull
//  data from a single structure to facilitate usage with multiple-contexts (all
//  g_XXXX access changed to bd->XXXX). 2021-06-25: DirectX9: Explicitly disable
//  texture state stages after >= 1. 2021-05-19: DirectX9: Replaced direct
//  access to ImDrawCmd::TextureId with a call to ImDrawCmd::GetTexID(). (will
...
static bool ImGui_ImplDX9_CheckFormatSupport(IDirect3DDevice9 *pDevice,
                                             D3DFORMAT format) {
...
static bool ImGui_ImplDX9_CreateFontsTexture() {
  ...
  if (bd->pd3dDevice->CreateTexture(
          ...
          rgba_support ? D3DFMT_A8B8G8R8 : D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT,
